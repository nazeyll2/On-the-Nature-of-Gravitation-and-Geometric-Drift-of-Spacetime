...
- Covariant teleparallel formulation
- Drift-field interpretation of gravity
- Derivation of modified field equations
- Vacuum and matter-sector solutions
- Newtonian and Schwarzschild limits
- MOND-like galactic behavior
- Flat rotation curve generation
- Baryonic Tully–Fisher relation
- Degree-of-freedom analysis
- Local Lorentz covariance analysis

---

## Repository Structure

- `gdv_field_equations.py` — Full symbolic derivation of the GDV field equations
...
- General Relativity in the TEGR limit
- Newtonian gravity in the weak-field regime
...
This project is currently under active development and analytical verification.
...
Melih Gümüş & Dr. Bilgehan Barış Öner
